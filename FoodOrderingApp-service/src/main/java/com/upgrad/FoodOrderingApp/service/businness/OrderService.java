...
public class OrderService {
    ...
    public OrdersEntity saveOrder(final OrdersEntity order) throws AuthorizationFailedException{
        ...
        OrdersEntity orderPlaced = orderDao.saveOrder(order);
    ...
    @Transactional(propagation = Propagation.REQUIRED)
    public List<OrdersEntity> getOrdersByCustomers(final String customerId){
